...
function generateSessionQuestions() {
  ...
  sessionQuestions.easy = getRandomQuestions(window.quizData.easy, 10)
  sessionQuestions.medium = getRandomQuestions(window.quizData.medium, 10)
  sessionQuestions.hard = getRandomQuestions(window.quizData.hard, 10)
}
...
function updateFloatingButton() {
  const shouldShow =
    gameState === "leaderboard" || gameState === "about" || gameState === "results" || gameState === "gameOver"
