var quizData = {
  easy: [
    ...
    {
      question:
        "Fill in the blank: The word 'photogrammetry' comes from the Greek words 'photo' meaning light, 'gramma' meaning ______, and 'metron' meaning measure.",
      type: "fill",
      answer: "drawing",
    ...
    },
    {
      ...
      type: "multiple",
      options: ["a) Aerial cameras", "b) Satellite sensors", "c) Sketchbooks", "d) UAV drones"],
      answer: "c",
    ...
    {
      question:
        "Fill in the blank: Photogrammetry requires at least ______ photographs taken from different positions to measure depth.",
      type: "fill",
      answer: "two",
  ...
  medium: [
    {
      ...
      type: "multiple",
      options: ["a) Photography", "b) Cartography", "c) Photogrammetry", "d) Topography"],
      answer: "c",
    ...
    {
      question:
        "Fill in the blank: In aerial photogrammetry, photographs are usually taken with the camera axis pointing ______.",
      type: "fill",
      answer: "vertically",
    ...
    },
    {
      ...
      type: "multiple",
      options: ["a) Image resolution", "b) Camera calibration", "c) Color of the object", "d) Overlap between photos"],
      answer: "c",
  ...
  hard: [
    {
      question:
        "Which mathematical principle allows photogrammetry to determine the 3D position of points from 2D images?",
      type: "multiple",
      options: ["a) Similar triangles", "b) Pythagorean theorem", "c) Law of sines", "d) Circle theorems"],
      answer: "a",
      hint: "It's about proportional shapes.",
    },
    {
      question:
        "True or False: In photogrammetry, parallax is the apparent displacement of an object when viewed from two different positions.",
      type: "boolean",
      answer: true,
    ...
    {
      question:
        "Fill in the blank: The ratio of the camera's focal length to the flying height determines the image ______.",
      type: "fill",
      answer: "scale",
    ...
    },
    {
      ...
      type: "multiple",
      options: ["a) GPS and IMU", "b) Photoshop", "c) Audio sensors", "d) Thermal blankets"],
      answer: "a",
    ...
    {
      question:
        "Fill in the blank: In satellite photogrammetry, the distance between two image capture points is called the ______.",
      type: "fill",
      answer: "baseline",
    ...
    },
    {
      ...
      type: "multiple",
      options: ["a) Image acquisition", "b) Interior orientation", "c) Feature scaling", "d) Triangulation"],
      answer: "c",
    ...
    {
      question:
        "Fill in the blank: In photogrammetry, the Ground Sampling Distance (GSD) represents the size of one ______ in real-world units.",
      type: "fill",
      answer: "pixel",
